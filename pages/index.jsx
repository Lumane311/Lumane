...
const STORES = {
  amazon:  { name:"Amazon",  emoji:"ðŸ“¦", color:"#FF9900", active:true,  tag:"lumanehair-21", buildUrl:(q,t)=>`https://www.amazon.com/s?k=${encodeURIComponent(q)}&tag=${t}` },
  sephora: { name:"Sephora", emoji:"ðŸ–¤", color:"#E75480", active:true,  tag:"", buildUrl:(q)=>`https://www.sephora.com/search?keyword=${encodeURIComponent(q)}` },
  iherb:   { name:"iHerb",   emoji:"ðŸŒ¿", color:"#5AAA46", active:true,  tag:"TU_CODIGO_IHERB", buildUrl:(q,t)=>`https://www.iherb.com/search?kw=${encodeURIComponent(q)}&rcode=${t}` },
  druni:   { name:"Druni",   emoji:"ðŸ’œ", color:"#6B1F8A", active:true,  tag:"", buildUrl:(q)=>`https://www.druni.es/buscar?q=${encodeURIComponent(q)}` },
};

const HAIR_SYSTEM = [
  { id:"1A", group:"lacio",    emoji:"ã€°ï¸", hue:38,  desc:"Lacio ultra fino. Tiende a ser graso." },
  { id:"1B", group:"lacio",    emoji:"ã€°ï¸", hue:42,  desc:"Lacio normal con movimiento natural." },
  { id:"1C", group:"lacio",    emoji:"ã€°ï¸", hue:46,  desc:"Lacio grueso con volumen. Frizz leve." },
  { id:"2A", group:"ondulado", emoji:"ã€œ",  hue:180, desc:"Ondas suaves en S. FÃ¡cil de definir." },
  { id:"2B", group:"ondulado", emoji:"ã€œ",  hue:185, desc:"Ondas medianas desde la raÃ­z." },
  { id:"2C", group:"ondulado", emoji:"ã€œ",  hue:190, desc:"Ondas pronunciadas casi rizos." },
  { id:"3A", group:"rizado",   emoji:"ðŸŒ€", hue:280, desc:"Rizos amplios y brillantes." },
  { id:"3B", group:"rizado",   emoji:"ðŸŒ€", hue:290, desc:"Rizos medianos y densos." },
  { id:"3C", group:"rizado",   emoji:"ðŸŒ€", hue:300, desc:"Rizos apretados tipo lÃ¡piz." },
  { id:"4A", group:"afro",     emoji:"âœ¦",  hue:30,  desc:"Coils suaves en S." },
  { id:"4B", group:"afro",     emoji:"âœ¦",  hue:25,  desc:"Coils zigzag. Muy frÃ¡gil." },
  { id:"4C", group:"afro",     emoji:"âœ¦",  hue:20,  desc:"Coils ultra apretados." },
];

const PRICE_LABELS = {
  eco: { label:"ðŸ’š Eco",     color:"#5A9A5A", bg:"rgba(90,154,90,.1)",   border:"rgba(90,154,90,.3)" },
  mid: { label:"ðŸ’› Medio",   color:"#B8920A", bg:"rgba(184,146,10,.1)",  border:"rgba(184,146,10,.3)" },
  lux: { label:"ðŸ’Ž Premium", color:"#C4687A", bg:"rgba(196,104,122,.1)", border:"rgba(196,104,122,.3)" },
};

const FILTER_CATS = [
  { id:"all",       label:"Todos",        emoji:"âœ¦",  sub:null },
  { id:"lacio",     label:"Lacio",        emoji:"ã€°ï¸", sub:["1A","1B","1C"] },
  { id:"1A",        label:"1A",           emoji:"ã€°ï¸", sub:null },
  { id:"1B",        label:"1B",           emoji:"ã€°ï¸", sub:null },
  { id:"1C",        label:"1C",           emoji:"ã€°ï¸", sub:null },
  { id:"ondulado",  label:"Ondulado",     emoji:"ã€œ",  sub:["2A","2B","2C"] },
  { id:"2A",        label:"2A",           emoji:"ã€œ",  sub:null },
  { id:"2B",        label:"2B",           emoji:"ã€œ",  sub:null },
  { id:"2C",        label:"2C",           emoji:"ã€œ",  sub:null },
  { id:"rizado",    label:"Rizado",       emoji:"ðŸŒ€", sub:["3A","3B","3C"] },
  { id:"3A",        label:"3A",           emoji:"ðŸŒ€", sub:null },
  { id:"3B",        label:"3B",           emoji:"ðŸŒ€", sub:null },
  { id:"3C",        label:"3C",           emoji:"ðŸŒ€", sub:null },
  { id:"afro",      label:"Afro/Coily",   emoji:"âœ¦",  sub:["4A","4B","4C"] },
  { id:"4A",        label:"4A",           emoji:"âœ¦",  sub:null },
  { id:"4B",        label:"4B",           emoji:"âœ¦",  sub:null },
  { id:"4C",        label:"4C",           emoji:"âœ¦",  sub:null },
  { id:"caspa",     label:"Caspa",        emoji:"â„ï¸", sub:null },
  { id:"caida",     label:"CaÃ­da",        emoji:"ðŸ‚", sub:null },
  { id:"cuero",     label:"Cuero",        emoji:"ðŸ”¬", sub:null },
  { id:"regenerar", label:"Regenerar",    emoji:"ðŸŒ±", sub:null },
  { id:"hombre",    label:"Hombre",       emoji:"ðŸ’ª", sub:null },
  { id:"cal",       label:"Agua Cal",     emoji:"ðŸ’§", sub:null },
];

const QUESTIONS = [
  { id:"gender",  icon:"ðŸŒ", q:"Â¿Con quÃ© gÃ©nero te identificas?",
    opts:[{l:"Mujer",v:"mujer",i:"ðŸ‘©"},{l:"Hombre",v:"hombre",i:"ðŸ‘¨"},{l:"No binario",v:"neutro",i:"ðŸ§‘"}] },
  { id:"group",   icon:"ã€°ï¸", q:"Â¿CuÃ¡l es el grupo general de tu cabello?",
    opts:[{l:"Lacio",v:"lacio",i:"ã€°ï¸"},{l:"Ondulado",v:"ondulado",i:"ã€œ"},{l:"Rizado",v:"rizado",i:"ðŸŒ€"},{l:"Afro/Coily",v:"afro",i:"âœ¦"}] },
  { id:"subtype", icon:"ðŸ”Ž", q:"Â¿CuÃ¡l describe mejor tu tipo especÃ­fico?", opts:[] },
  { id:"scalp",   icon:"ðŸ”¬", q:"Â¿Alguna preocupaciÃ³n con tu cuero cabelludo?",
    opts:[{l:"Caspa",v:"caspa",i:"â„ï¸"},{l:"Cuero graso",v:"graso",i:"ðŸƒ"},{l:"Cuero sensible",v:"sensible",i:"ðŸŒ¸"},{l:"Todo bien",v:"normal",i:"âœ…"}] },
  { id:"concern", icon:"ðŸŽ¯", q:"Â¿Tu mayor preocupaciÃ³n capilar?",
    opts:[{l:"CaÃ­da excesiva",v:"caida",i:"ðŸ‚"},{l:"Frizz y volumen",v:"frizz",i:"âš¡"},{l:"Cabello daÃ±ado",v:"dano",i:"ðŸ’”"},{l:"Falta de brillo",v:"brillo",i:"âœ¨"}] },
  { id:"damage",  icon:"ðŸ§ª", q:"Â¿Tu cabello ha recibido tratamientos?",
    opts:[{l:"Tinte/decoloraciÃ³n",v:"tinte",i:"ðŸŽ¨"},{l:"Alisado/keratina",v:"quimico",i:"ðŸ§´"},{l:"Calor frecuente",v:"calor",i:"ðŸ”¥"},{l:"Virgen y natural",v:"virgen",i:"ðŸŒ±"}] },
];

const SUBTYPES = {
  lacio:   [{l:"1A â€” Ultrafino",v:"1A",i:"ã€°ï¸"},{l:"1B â€” Liso normal",v:"1B",i:"ã€°ï¸"},{l:"1C â€” Liso grueso",v:"1C",i:"ã€°ï¸"}],
  ondulado:[{l:"2A â€” Ondas suaves",v:"2A",i:"ã€œ"},{l:"2B â€” Ondas medianas",v:"2B",i:"ã€œ"},{l:"2C â€” Ondas pronunciadas",v:"2C",i:"ã€œ"}],
  rizado:  [{l:"3A â€” Rizos grandes",v:"3A",i:"ðŸŒ€"},{l:"3B â€” Rizos medianos",v:"3B",i:"ðŸŒ€"},{l:"3C â€” Rizos apretados",v:"3C",i:"ðŸŒ€"}],
  afro:    [{l:"4A â€” Coils suaves",v:"4A",i:"âœ¦"},{l:"4B â€” Coils zigzag",v:"4B",i:"âœ¦"},{l:"4C â€” Ultra apretados",v:"4C",i:"âœ¦"}],
};

const SHOP = [
  { id:1,  cat:"1A", step:"Limpieza",    emoji:"ðŸ«§", hue:38,  tag:"Esencial",  desc:"Limpieza sin peso que levanta la raÃ­z del cabello fino.", sq:"volumizing shampoo fine straight hair", howTo:"1. Solo en cuero cabelludo.\n2. Masajea 2 min.\n3. Deja resbalar.\n4. Agua frÃ­a.\n5. Nunca en puntas.",
    prices:{eco:{price:6.99,name:"Shampoo Volumen BÃ¡sico",brand:"Pantene"},mid:{price:14.99,name:"Shampoo Voluminizador 1A",brand:"OGX/Redken"},lux:{price:32.00,name:"Shampoo Volumen Pro",brand:"Kerastase"}} },
  { id:2,  cat:"1A", step:"Acondicionador",emoji:"ðŸ’§",hue:40,  tag:"-20%",     desc:"HidrataciÃ³n ultraligera que no aplana el cabello 1A.",     sq:"lightweight conditioner fine hair",        howTo:"1. Solo medios a puntas.\n2. Peina con dedos.\n3. 2 min.\n4. Agua frÃ­a.\n5. Nunca en raÃ­z.",
  ...
  { id:3,  cat:"1B", step:"Limpieza",    emoji:"ðŸ«§", hue:42,  tag:"Bestseller",desc:"Equilibra el sebo y mantiene el brillo del lacio 1B.",      sq:"balancing shampoo straight normal hair",   howTo:"1. Cuero mojado.\n2. Circular 2 min.\n3. Espuma largos.\n4. Agua frÃ­a.\n5. 2-3x semana.",
    prices:{eco:{price:5.49,name:"Shampoo Liso BÃ¡sico",brand:"Elvive"},mid:{price:12.99,name:"Shampoo Equilibrio Lacio",brand:"OGX"},lux:{price:29.00,name:"Shampoo Liso Perfecto",brand:"Kerastase"}} },
  { id:4,  cat:"1C", step:"Limpieza",    emoji:"ðŸ«§", hue:46,  tag:"Bestseller",desc:"Controla el volumen excesivo del liso grueso 1C.",           sq:"smoothing shampoo thick straight hair",    howTo:"1. Abundante cuero.\n2. Masajea 3 min.\n3. Trabaja espuma.\n4. Enjuaga bien.\n5. Siempre acondicionador.",
    prices:{eco:{price:5.99,name:"Shampoo Alisante BÃ¡sico",brand:"Fructis"},mid:{price:13.99,name:"Shampoo Domador 1C",brand:"OGX"},lux:{price:31.00,name:"Shampoo Disciplina Pro",brand:"Kerastase"}} },
  { id:5,  cat:"2A", step:"Limpieza",    emoji:"ðŸŒŠ", hue:178, tag:"Esencial",  desc:"Limpia sin resecar las ondas suaves del tipo 2A.",           sq:"gentle shampoo wavy 2a sulfate free",      howTo:"1. Cuero cabelludo.\n2. No frotar largos.\n3. Deja resbalar.\n4. Agua frÃ­a.\n5. Solo 2x semana.",
  ...
  { id:6,  cat:"2A", step:"DefiniciÃ³n",  emoji:"ã€œ", hue:180, tag:"Bestseller",desc:"Gel ultraligero que define las ondas 2A sin crunch.",         sq:"light defining gel wavy 2a",              howTo:"1. Muy hÃºmedo secciones.\n2. Escrunching arriba.\n3. No tocar al secar.\n4. Disuelve crunch.\n5. Difusor media.",
  ...
  { id:7,  cat:"2B", step:"Limpieza",    emoji:"ðŸ«§", hue:185, tag:"Bestseller",desc:"Sin sulfatos para mantener la hidrataciÃ³n de las ondas 2B.", sq:"co wash wavy 2b sulfate free",            howTo:"1. Generoso cuero.\n2. Masajea bien.\n3. Distribuye largos.\n4. 2 min.\n5. Enjuaga bien.",
    prices:{eco:{price:6.49,name:"Co-Wash 2B BÃ¡sico",brand:"Cantu"},mid:{price:14.99,name:"Co-Wash Cremoso 2B",brand:"OGX"},lux:{price:29.00,name:"Co-Wash Nutritivo 2B",brand:"DevaCurl"}} },
  { id:8,  cat:"2B", step:"DefiniciÃ³n",  emoji:"ã€œ", hue:187, tag:"-23%",     desc:"Define ondas 2B sin rigidez. Hidrata y controla el frizz.",  sq:"curl cream defining wavy 2b",             howTo:"1. HÃºmedo tras acondicionador.\n2. Praying hands.\n3. Escruncha arriba.\n4. Difusor bajo.\n5. No tocar hasta seco.",
  ...
  { id:9,  cat:"2C", step:"Limpieza",    emoji:"ðŸ«§", hue:192, tag:"Bestseller",desc:"MÃ©todo Curly Girl para ondas 2C. Sin sulfatos ni siliconas.", sq:"CGM shampoo wavy 2c curly girl",          howTo:"1. Cuero mojado.\n2. Masajea 3 min.\n3. Enjuaga tibia.\n4. Max 2-3 dÃ­as.\n5. Siempre acondicionador.",
  ...
  { id:10, cat:"3A", step:"Limpieza",    emoji:"ðŸŒ€", hue:275, tag:"Bestseller",desc:"Sin sulfatos preservando la elasticidad de los rizos 3A.",   sq:"sulfate free shampoo curly 3a",           howTo:"1. Circular 2 min.\n2. No frotar largos.\n3. Enjuaga suave.\n4. Agua frÃ­a.\n5. 2-3x semana.",
  ...
  { id:11, cat:"3A", step:"DefiniciÃ³n",  emoji:"ðŸŒ€", hue:282, tag:"Nuevo",     desc:"Gel media fijaciÃ³n para rizos 3A con bounce y brillo.",      sq:"defining gel curly 3a bounce",            howTo:"1. Muy hÃºmedo secciones.\n2. Praying hands.\n3. No separar.\n4. Difusor baja-media.\n5. Cast al 100% seco.",
  ...
  { id:12, cat:"3B", step:"Limpieza",    emoji:"ðŸŒ€", hue:288, tag:"Bestseller",desc:"Limpieza con acondicionador para los aceites naturales 3B.",  sq:"co wash moisturizing curly 3b",           howTo:"1. Cuero y masajea.\n2. Distribuye rizos.\n3. 3 min.\n4. Enjuaga bien.\n5. Clarificante 1x mes.",
  ...
  { id:13, cat:"3C", step:"Limpieza",    emoji:"ðŸŒ€", hue:300, tag:"Bestseller",desc:"Sin sulfatos para rizos apretados 3C. MÃ¡xima hidrataciÃ³n.",  sq:"moisturizing shampoo tight curls 3c",      howTo:"1. Divide 4 secciones.\n2. Cuero cada secciÃ³n.\n3. Masajea 3 min.\n4. Enjuaga.\n5. Nunca toalla, usa camiseta.",
  ...
  { id:14, cat:"3C", step:"HidrataciÃ³n", emoji:"ðŸ’¦", hue:303, tag:"-27%",     desc:"Acondicionador profundo que hidrata y define los rizos 3C.", sq:"deep conditioner tight curls 3c",         howTo:"1. Abundante tras shampoo.\n2. Peine ancho.\n3. Gorro + calor 30 min.\n4. Agua frÃ­a.\n5. Define inmediatamente.",
  ...
  { id:15, cat:"4A", step:"Limpieza",    emoji:"âœ¦",  hue:30,  tag:"Bestseller",desc:"Sin sulfatos que preserva la hidrataciÃ³n de los coils 4A.", sq:"sulfate free shampoo 4a coils",           howTo:"1. Divide 4 secciones.\n2. Cuero por secciÃ³n.\n3. Masajea 3-4 min.\n4. Enjuaga tibia.\n5. Max 1-2x semana.",
  ...
  { id:16, cat:"4A", step:"HidrataciÃ³n", emoji:"ðŸ’§", hue:33,  tag:"-25%",     desc:"HidrataciÃ³n intensiva para coils 4A. MÃ©todo LOC recomendado.",sq:"deep conditioner 4a coils LOC",          howTo:"1. HÃºmedo secciÃ³n a secciÃ³n.\n2. Peine ancho.\n3. Gorro + calor 30-45 min.\n4. Agua frÃ­a.\n5. Leave-in inmediato.",
  ...
  { id:17, cat:"4B", step:"Limpieza",    emoji:"âœ¦",  hue:25,  tag:"Bestseller",desc:"Co-wash ultra nutritivo para el patrÃ³n 4B en zigzag.",       sq:"co wash moisturizing 4b natural hair",     howTo:"1. Divide 8-10 secciones.\n2. Aplica y masajea.\n3. Solo presionar.\n4. Enjuaga secciÃ³n.\n5. Alterna shampoo cada 2-3.",
  ...
  { id:18, cat:"4C", step:"HidrataciÃ³n", emoji:"âœ¦",  hue:20,  tag:"Bestseller",desc:"HidrataciÃ³n mÃ¡xima para el cabello 4C mÃ¡s frÃ¡gil.",          sq:"deep moisture treatment 4c ultra dry",     howTo:"1. Divide 10-12 secciones.\n2. Aplica generoso hÃºmedo.\n3. Gorro + calor 45 min.\n4. Agua frÃ­a.\n5. Leave-in inmediato.",
  ...
  { id:19, cat:"caspa", step:"Shampoo",  emoji:"â„ï¸", hue:210, tag:"Bestseller",desc:"Zinc y ketoconazol que eliminan la caspa desde la primera semana.",sq:"anti dandruff shampoo zinc ketoconazole",howTo:"1. Cuero mojado.\n2. Masajea 3-5 min.\n3. Deja 2 min.\n4. Enjuaga bien.\n5. 3x semana primeras 4 semanas.",
    prices:{eco:{price:5.49,name:"Anti-Caspa BÃ¡sico",brand:"Head&Shoulders"},mid:{price:12.99,name:"Anti-Caspa Zinc",brand:"Nizoral"},lux:{price:28.00,name:"Anti-Caspa Pro",brand:"Ducray"}} },
  { id:20, cat:"caida", step:"TÃ³nico",   emoji:"ðŸ‚", hue:90,  tag:"Bestseller",desc:"CafeÃ­na y biotina que estimulan el folÃ­culo y reducen la caÃ­da.",sq:"hair loss tonic biotin caffeine",        howTo:"1. Zonas de caÃ­da.\n2. Circular 5 min.\n3. No enjuagar.\n4. Cada noche.\n5. Resultados 8-12 semanas.",
    prices:{eco:{price:7.99,name:"TÃ³nico AnticaÃ­da",brand:"Alpecin"},mid:{price:16.99,name:"TÃ³nico Biotina + CafeÃ­na",brand:"Vichy"},lux:{price:35.00,name:"TÃ³nico AnticaÃ­da Pro",brand:"Kerastase"}} },
  { id:21, cat:"cuero", step:"Exfoliante",emoji:"ðŸ”¬",hue:160, tag:"Bestseller",desc:"AzÃºcar y Ã¡cido glicÃ³lico que eliminan cÃ©lulas muertas.",       sq:"scalp scrub exfoliant glycolic acid",      howTo:"1. Cuero mojado antes shampoo.\n2. Circular 3-5 min.\n3. 2 min.\n4. Enjuaga y shampoo.\n5. 1x semana.",
  ...
  { id:22, cat:"regenerar",step:"Mascarilla",emoji:"ðŸŒ±",hue:120,tag:"Bestseller",desc:"Ricino, argÃ¡n y mango que regeneran el cabello daÃ±ado.",    sq:"hair regenerating mask castor argan",      howTo:"1. HÃºmedo raÃ­z a puntas.\n2. Divide secciones.\n3. Gorro + calor 25-30 min.\n4. Agua frÃ­a.\n5. 2x semana primeras 4 semanas.",
  ...
  { id:23, cat:"hombre", step:"Limpieza",emoji:"ðŸ’ª", hue:220, tag:"Bestseller",desc:"Shampoo + acondicionador para hombres activos. Frescura duradera.",sq:"2 in 1 shampoo conditioner men",       howTo:"1. Cabello mojado.\n2. Masajea 2-3 min.\n3. Distribuye largos.\n4. 1 min.\n5. Enjuaga bien.",
    prices:{eco:{price:5.49,name:"2-en-1 Hombre BÃ¡sico",brand:"H&S Men"},mid:{price:12.99,name:"2-en-1 Active Fresh",brand:"American Crew"},lux:{price:28.00,name:"Shampoo Hombre Premium",brand:"Jack Black"}} },
  { id:24, cat:"hombre", step:"AnticaÃ­da",emoji:"âš¡", hue:210, tag:"-20%",    desc:"CafeÃ­na y zinc para frenar la caÃ­da masculina.",               sq:"hair loss tonic men caffeine zinc",        howTo:"1. Zonas de menor densidad.\n2. Circular 5 min.\n3. No enjuagar.\n4. Cada noche.\n5. Resultados 8-16 semanas.",
    prices:{eco:{price:8.99,name:"TÃ³nico AnticaÃ­da Hombre",brand:"Alpecin"},mid:{price:18.99,name:"TÃ³nico Men Forte",brand:"Vichy"},lux:{price:38.00,name:"TÃ³nico Premium Hombre",brand:"Kerastase"}} },
  { id:25, cat:"cal", step:"Quelante",   emoji:"ðŸ’§", hue:200, tag:"Esencial",  desc:"Elimina depÃ³sitos de cal del agua dura que apagan el brillo.", sq:"chelating shampoo hard water limescale",  howTo:"1. Generoso en mojado.\n2. Masajea 3-5 min.\n3. 2 min extra.\n4. Enjuaga bien.\n5. 1x semana.",
    prices:{eco:{price:7.99,name:"Shampoo Quelante BÃ¡sico",brand:"Fructis"},mid:{price:16.99,name:"Shampoo Anti-Cal",brand:"Malibu C"},lux:{price:34.00,name:"Shampoo Quelante Pro",brand:"Olaplex"}} },
  { id:26, cat:"cal", step:"Filtro",     emoji:"ðŸš¿", hue:195, tag:"Bestseller",desc:"Filtra cloro y minerales del agua dura antes de tocar tu cabello.",sq:"shower filter hard water vitamin C",    howTo:"1. Instala sin herramientas.\n2. Cambia cartucho 3-6 meses.\n3. Diferencia desde el 1er lavado.\n4. Compatible todo cabezal.\n5. Reduce caÃ­da por cal hasta 60%.",
    prices:{eco:{price:14.99,name:"Filtro Ducha BÃ¡sico",brand:"Aquasana"},mid:{price:29.99,name:"Filtro Vitamina C",brand:"AquaBliss"},lux:{price:59.99,name:"Filtro Ducha Pro",brand:"Jolie"}} },
  { id:27, cat:"cal", step:"Tratamiento",emoji:"âš—ï¸", hue:205, tag:"-25%",    desc:"Vitamina C neutraliza minerales y restaura el brillo perdido.", sq:"vitamin C hair treatment hard water",      howTo:"1. Limpio hÃºmedo.\n2. Masajea 3 min.\n3. Gorro 5-10 min.\n4. Agua frÃ­a.\n5. 1x semana intensivo.",
  ...
  { id:28, cat:"cal", step:"Mascarilla", emoji:"ðŸ‹", hue:55,  tag:"Bestseller",desc:"Vinagre de sidra y Ã¡cido mÃ¡lico disuelven depÃ³sitos de cal.",  sq:"apple cider vinegar hair mask hard water", howTo:"1. Limpio hÃºmedo.\n2. Masajea bien.\n3. 10-15 min.\n4. Enjuaga bien.\n5. El olor desaparece. 1x semana.",
    prices:{eco:{price:5.99,name:"Mascarilla Vinagre",brand:"Garnier"},mid:{price:13.99,name:"Mascarilla ACV Anti-Cal",brand:"dpHUE"},lux:{price:28.00,name:"Mascarilla Ãcido MÃ¡lico",brand:"Briogeo"}} },
];

function ProductosRecomendados() {
  const prods = [
    { id:1, emoji:"ðŸŒ¿", nombre:"Aceite de ArgÃ¡n Puro",      marca:"OGX",          beneficio:"Brillo y nutriciÃ³n intensa para todo tipo de cabello",    tag:"MÃ¡s vendido", tagColor:"#5AAA46",
    ...
    { id:2, emoji:"ðŸ’§", nombre:"Shampoo Sin Sulfatos",       marca:"Cantu",        beneficio:"Limpieza suave que respeta los rizos y ondas naturales",   tag:"CGM âœ“",     tagColor:"#7B68EE",
    ...
    { id:3, emoji:"ðŸ§´", nombre:"Mascarilla Reparadora",      marca:"Olaplex",      beneficio:"Reconstruye el cabello daÃ±ado por tinte o calor",          tag:"-30%",      tagColor:"#E75480",
    ...
    { id:4, emoji:"ðŸ‚", nombre:"TÃ³nico AnticaÃ­da Biotina",   marca:"Vichy Dercos", beneficio:"CafeÃ­na y biotina que frenan la caÃ­da desde la raÃ­z",      tag:"ClÃ­nico",   tagColor:"#2E86AB",
    ...
    { id:5, emoji:"ðŸŒ€", nombre:"Crema Definidora de Rizos",  marca:"Shea Moisture",beneficio:"Define y humecta rizos 3A-3C sin efecto plÃ¡stico",         tag:"Natural",   tagColor:"#5AAA46",
    ...
    { id:6, emoji:"ðŸš¿", nombre:"Filtro Ducha Anti-Cal",      marca:"AquaBliss",    beneficio:"Filtra el cloro y la cal que destruye el cabello en Europa",tag:"Esencial",  tagColor:"#B8920A",
  ...
  const tiendas = [
    { key:"amazon",  label:"Amazon",  emoji:"ðŸ“¦", bg:"#FF9900" },
    { key:"iherb",   label:"iHerb",   emoji:"ðŸŒ¿", bg:"#5AAA46" },
    { key:"sephora", label:"Sephora", emoji:"ðŸ–¤", bg:"#E75480" },
    { key:"druni",   label:"Druni",   emoji:"ðŸ’œ", bg:"#6B1F8A" },
  ];
  return (
    <section style={{width:"100%",maxWidth:960,margin:"0 auto",padding:"3rem 1rem 2rem",fontFamily:"'Outfit',sans-serif"}}>
      <div style={{textAlign:"center",marginBottom:32}}>
        <span style={{fontSize:11,fontWeight:700,letterSpacing:"0.18em",textTransform:"uppercase",color:"#C4687A",marginBottom:8,display:"block"}}>âœ¦ SelecciÃ³n LuMane</span>
        ...
        <p style={{fontSize:14,color:"#888",margin:0}}>Los mÃ¡s valorados Â· Amazon Â· iHerb Â· Sephora Â· Druni</p>
      </div>
          ...
          return (
            <div key={p.id} style={{background:"#fff",border:"1.5px solid #f0e8ea",borderRadius:18,padding:"22px 18px 18px",display:"flex",flexDirection:"column",gap:10,boxShadow:"0 2px 16px rgba(196,104,122,0.08)",position:"relative"}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:6,marginTop:6}}>
                <a href={p.amazon} target="_blank" rel="noopener noreferrer" style={{background:"#FF9900",color:"#fff",borderRadius:10,padding:"9px 4px",fontSize:12,fontWeight:700,textDecoration:"none",textAlign:"center",display:"block"}}>ðŸ“¦ Amazon</a>
                <a href={p.iherb} target="_blank" rel="noopener noreferrer" style={{background:"#5AAA46",color:"#fff",borderRadius:10,padding:"9px 4px",fontSize:12,fontWeight:700,textDecoration:"none",textAlign:"center",display:"block"}}>ðŸŒ¿ iHerb</a>
                <a href={p.sephora} target="_blank" rel="noopener noreferrer" style={{background:"#E75480",color:"#fff",borderRadius:10,padding:"9px 4px",fontSize:12,fontWeight:700,textDecoration:"none",textAlign:"center",display:"block"}}>ðŸ–¤ Sephora</a>
                <a href={p.druni} target="_blank" rel="noopener noreferrer" style={{background:"#6B1F8A",color:"#fff",borderRadius:10,padding:"9px 4px",fontSize:12,fontWeight:700,textDecoration:"none",textAlign:"center",display:"block"}}>ðŸ’œ Druni</a>
              </div>
            </div>
          );
        })}
      ...
      <p style={{textAlign:"center",fontSize:11,color:"#bbb",marginTop:20}}>
        * Algunos enlaces son de afiliado. LuMane puede recibir una pequeÃ±a comisiÃ³n sin coste adicional para ti.
      </p>
    </section>
  );
}
...
function ReviewsSection() {
  const [reviews, setReviews] = React.useState([
    { id:1, nombre:"MarÃ­a G.", pais:"ðŸ‡²ðŸ‡½ MÃ©xico",    tipo:"3C", estrellas:5, texto:"Â¡IncreÃ­ble! Por fin una app que entiende mi cabello rizado. La rutina que me dio cambiÃ³ todo.", fecha:"Hace 2 dÃ­as" },
    { id:2, nombre:"Valentina R.", pais:"ðŸ‡¨ðŸ‡´ Colombia", tipo:"2B", estrellas:5, texto:"Llevaba aÃ±os gastando dinero en productos que no funcionaban. LuMane me dio exactamente lo que necesitaba.", fecha:"Hace 5 dÃ­as" },
    { id:3, nombre:"Andrea M.", pais:"ðŸ‡ªðŸ‡¸ EspaÃ±a",   tipo:"Cal", estrellas:5, texto:"El agua de Madrid me tenÃ­a el cabello horrible. Los productos anti-cal son una revoluciÃ³n total.", fecha:"Hace 1 semana" },
    { id:4, nombre:"Carlos P.", pais:"ðŸ‡¦ðŸ‡· Argentina",  tipo:"1C", estrellas:4, texto:"Muy buena pÃ¡gina, fÃ¡cil de usar y los productos que recomienda son reales y accesibles.", fecha:"Hace 1 semana" },
    { id:5, nombre:"SofÃ­a L.", pais:"ðŸ‡¬ðŸ‡¹ Guatemala",  tipo:"4A", estrellas:5, texto:"Nunca pensÃ© que habrÃ­a una app que cubriera mi tipo de cabello afro. Â¡Estoy emocionada!", fecha:"Hace 2 semanas" },
  ]);
  ...
  function enviar() {
    ...
    const nuevo = { id:Date.now(), nombre:nombre.trim(), pais:pais||"ðŸŒŽ", tipo:"", estrellas, texto:texto.trim(), fecha:"Ahora mismo" };
    ...
    <section style={{background:"#F5E8EA",padding:"3rem 1.5rem",fontFamily:"'Outfit',sans-serif"}}>
      <div style={{maxWidth:760,margin:"0 auto"}}>
        <div style={{textAlign:"center",marginBottom:28}}>
          <span style={{fontSize:11,fontWeight:700,letterSpacing:"0.18em",textTransform:"uppercase",color:"#C4687A",display:"block",marginBottom:6}}>âœ¦ Opiniones reales</span>
          ...
          <div style={{display:"flex",alignItems:"center",justifyContent:"center",gap:10,marginTop:8}}>
            <div style={{display:"flex",gap:3}}>
              {[1,2,3,4,5].map(s=>(
                <span key={s} style={{fontSize:20,color:s<=Math.round(promedio)?"#FFB800":"#ddd"}}>â˜…</span>
              ))}
            </div>
            ...
            <div key={r.id} style={{background:"#fff",borderRadius:16,padding:"18px 16px",border:"1.5px solid #f0e8ea",boxShadow:"0 2px 12px rgba(196,104,122,0.06)"}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:8}}>
                <div>
                  ...
                  <div style={{fontSize:12,color:"#999",marginTop:2}}>{r.pais}{r.tipo?" Â· Tipo "+r.tipo:""}</div>
                </div>
                <div style={{display:"flex",gap:2}}>
                  {[1,2,3,4,5].map(s=>(
                    <span key={s} style={{fontSize:13,color:s<=r.estrellas?"#FFB800":"#ddd"}}>â˜…</span>
                  ))}
                </div>
              </div>
        ...
        <div style={{background:"#fff",borderRadius:20,padding:"28px 24px",border:"1.5px solid rgba(196,104,122,.2)",boxShadow:"0 4px 20px rgba(196,104,122,.08)"}}>
          <h3 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:20,fontWeight:700,color:"#2A1018",marginBottom:4}}>Â¿Ya usaste LuMane?</h3>
          <p style={{fontSize:13,color:"#999",marginBottom:20}}>Deja tu opiniÃ³n y ayuda a otras personas a cuidar su cabello</p>

          <div style={{marginBottom:16}}>
            <div style={{fontSize:12,fontWeight:700,color:"#5A2030",letterSpacing:"0.08em",textTransform:"uppercase",marginBottom:8}}>Tu calificaciÃ³n</div>
            <div style={{display:"flex",gap:6}}>
              {[1,2,3,4,5].map(s=>(
                <span key={s}
                  ...
                  style={{fontSize:32,cursor:"pointer",color:s<=(hover||estrellas)?"#FFB800":"#ddd",transition:"color .15s"}}>â˜…</span>
              ))}
            </div>
          </div>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:12,marginBottom:12}}>
            <div>
              ...
              <input value={nombre} onChange={e=>setNombre(e.target.value)} placeholder="Ej: MarÃ­a G."
            ...
            <div>
              <label style={{fontSize:12,fontWeight:700,color:"#5A2030",letterSpacing:"0.08em",textTransform:"uppercase",display:"block",marginBottom:6}}>PaÃ­s</label>
              <input value={pais} onChange={e=>setPais(e.target.value)} placeholder="Ej: ðŸ‡²ðŸ‡½ MÃ©xico"
                style={{width:"100%",padding:"10px 12px",borderRadius:10,border:"1.5px solid rgba(196,104,122,.25)",fontFamily:"'Outfit',sans-serif",fontSize:14,color:"#2A1018",outline:"none",background:"#FDF4F5"}}/>
            </div>
          </div>
          ...
          <div style={{marginBottom:16}}>
            ...
            <textarea value={texto} onChange={e=>setTexto(e.target.value)} placeholder="Â¿QuÃ© te pareciÃ³ LuMane? Â¿CÃ³mo te ayudÃ³ con tu cabello?"
              rows={3}
          ...
          {enviado?(
            <div style={{background:"rgba(90,154,90,.1)",border:"1px solid rgba(90,154,90,.3)",borderRadius:10,padding:"12px",textAlign:"center",fontSize:14,color:"#3A7A3A",fontWeight:600}}>
              ðŸŽ‰ Â¡Gracias por tu opiniÃ³n! Ya aparece arriba.
            </div>
          ):(
...
function fallback(a){
  return {
    ...
    summary:"Con la rutina adecuada, tu cabello brillarÃ¡ con todo su potencial natural.",
    score:{hidratacion:7,fuerza:6,brillo:7,salud_cuero:7},
    products:[
      {order:1,step:"Limpieza",name:"Shampoo suave sin sulfatos",sq:"gentle sulfate free shampoo",why:"Limpia sin agredir la fibra.",howToApply:"1. Cuero mojado.\n2. Masajea 2 min.\n3. Agua frÃ­a.",freq:"2-3x semana",tip:"Agua frÃ­a cierra la cutÃ­cula.",avoid:"Agua muy caliente."},
      {order:2,step:"Acondicionado",name:"Acondicionador hidratante",sq:"moisturizing conditioner",why:"Repone la humedad.",howToApply:"1. Medios a puntas.\n2. Peine ancho.\n3. 5 min.\n4. Agua frÃ­a.",freq:"Cada lavado",tip:"Con cabello chorreando.",avoid:"Aplicar en raÃ­z."},
      {order:3,step:"Tratamiento",name:"Mascarilla nutritiva",sq:"weekly hair mask nourishing",why:"Repone nutrientes.",howToApply:"1. Limpio hÃºmedo.\n2. Gorro 15 min.\n3. Agua frÃ­a.",freq:"1x semana",tip:"Antes de un evento especial.",avoid:"Exceso de proteÃ­na."},
      {order:4,step:"Leave-in",name:"Leave-in sin aclarado",sq:"leave in conditioner",why:"Protege y define.",howToApply:"1. HÃºmedo en secciones.\n2. No enjuagar.",freq:"Cada lavado",tip:"Antes del difusor.",avoid:"Exceso de producto."},
      {order:5,step:"Sellado",name:"Aceite finalizador",sq:"lightweight hair oil shine",why:"Sella la cutÃ­cula y brillo.",howToApply:"1. 1-2 gotas en palmas.\n2. Solo en puntas.",freq:"Diario",tip:"Menos es mÃ¡s.",avoid:"RaÃ­z o cuero."},
    ],
    weeklyRoutine:["DÃ­as 1-2: Lavado completo","DÃ­as 3-4: Refrescar con leave-in","DÃ­as 5-6: Mascarilla + aceite","DÃ­a 7: Descanso"],
    ingredients:{buscar:["KaritÃ©","Aloe vera","Pantenol","ArgÃ¡n","Biotina"],evitar:["Sulfatos SLS","Alcohol desnaturalizado","Siliconas no solubles"]},
    lifestyle:["Duerme en funda de seda","Bebe 2 litros de agua al dÃ­a","Masajea el cuero 5 min diarios"],
  };
}
...
function LoginPage({onSuccess, onRegister}) {
  ...
  function doLogin(){
    ...
    } catch(e){ setError("Error al iniciar sesiÃ³n."); }
  }
    ...
    <div style={{minHeight:"85vh",display:"flex",alignItems:"center",justifyContent:"center",padding:"2rem 1.5rem 5rem",background:"#FDF4F5"}}>
      <div style={{maxWidth:"420px",width:"100%"}}>
        <div style={{textAlign:"center",marginBottom:"1.8rem"}}>
          ...
          <p style={{fontSize:"0.85rem",color:"#999"}}>Inicia sesiÃ³n para acceder a tu cuenta</p>
        </div>
        <div style={{background:"#fff",borderRadius:"1.5rem",padding:"2rem",border:"1.5px solid rgba(196,104,122,.15)",boxShadow:"0 8px 32px rgba(196,104,122,.08)"}}>
          ...
          <div style={{marginBottom:"1rem"}}>
            <label style={{fontSize:"0.65rem",fontWeight:700,color:"#5A2030",letterSpacing:"0.08em",textTransform:"uppercase",display:"block",marginBottom:"0.4rem"}}>Correo electrÃ³nico</label>
            <input
              type="email"
              value={email}
          ...
          <div style={{marginBottom:"1.5rem"}}>
            <label style={{fontSize:"0.65rem",fontWeight:700,color:"#5A2030",letterSpacing:"0.08em",textTransform:"uppercase",display:"block",marginBottom:"0.4rem"}}>ContraseÃ±a</label>
            <input
              type="password"
              value={pass}
          ...
          <p style={{textAlign:"center",fontSize:"0.78rem",color:"#999"}}>
            Â¿No tienes cuenta?{" "}
            <span onClick={onRegister} style={{color:"#C4687A",fontWeight:700,cursor:"pointer"}}>SuscrÃ­bete aquÃ­</span>
          </p>
        </div>
      </div>
    </div>
...
function RegisterPage({selectedPlan, onBack, onSuccess}) {
  ...
  async function doRegister(){
    ...
    if(regData.password !== regData.confirm){
      setRegError("Las contraseÃ±as no coinciden."); return;
    }
    if(regData.password.length < 6){
      setRegError("La contraseÃ±a debe tener al menos 6 caracteres."); return;
    }
    try {
    ...
    try {
      ...
      setRegError('Error de conexiÃ³n. Intenta de nuevo.');
      setLoading(false);
    }
  }
  ...
  return (
    <div style={{minHeight:"85vh",display:"flex",alignItems:"center",justifyContent:"center",padding:"2rem 1.5rem 5rem",background:"#FDF4F5"}}>
      <div style={{maxWidth:"480px",width:"100%"}}>
        <div style={{textAlign:"center",marginBottom:"1.8rem"}}>
          <div style={{fontSize:"0.65rem",color:"#C4687A",fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",marginBottom:"0.4rem"}}>âœ¦ Paso 1 de 2</div>
        ...
        <div style={{background:"#fff",borderRadius:"1.5rem",padding:"2rem",border:"1.5px solid rgba(196,104,122,.15)",boxShadow:"0 8px 32px rgba(196,104,122,.08)"}}>
          ...
          <div style={{marginBottom:"1rem"}}>
            <label style={{fontSize:"0.65rem",fontWeight:700,color:"#5A2030",letterSpacing:"0.08em",textTransform:"uppercase",display:"block",marginBottom:"0.4rem"}}>ContraseÃ±a * (mÃ­n. 6 caracteres)</label>
            <input type="password" value={regData.password} onChange={e=>setRegData(p=>({...p,password:e.target.value}))} placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢"
              style={{width:"100%",padding:"12px 14px",borderRadius:12,border:"1.5px solid rgba(196,104,122,.3)",fontFamily:"'Outfit',sans-serif",fontSize:15,color:"#2A1018",outline:"none",background:"#FDF4F5",boxSizing:"border-box"}}/>
          </div>
          <div style={{marginBottom:"1.5rem"}}>
            <label style={{fontSize:"0.65rem",fontWeight:700,color:"#5A2030",letterSpacing:"0.08em",textTransform:"uppercase",display:"block",marginBottom:"0.4rem"}}>Confirmar contraseÃ±a *</label>
            <input type="password" value={regData.confirm} onChange={e=>setRegData(p=>({...p,confirm:e.target.value}))} placeholder="â€¢â€¢â€¢â€¢â€¢â€¢â€¢â€¢"
              style={{width:"100%",padding:"12px 14px",borderRadius:12,border:"1.5px solid rgba(196,104,122,.3)",fontFamily:"'Outfit',sans-serif",fontSize:15,color:"#2A1018",outline:"none",background:"#FDF4F5",boxSizing:"border-box"}}/>
          </div>
          <button onClick={doRegister} disabled={loading}
            ...
            {loading?"Redirigiendo a Stripeâ€¦":"ðŸ”’ Continuar al pago seguro â†’"}
          </button>
        ...
        <p style={{textAlign:"center",fontSize:"0.68rem",color:"#bbb",marginTop:"1rem",lineHeight:1.5}}>
          ðŸ”’ Pago seguro con Stripe Â· Sin cargos 7 dÃ­as Â· Cancela cuando quieras
        </p>
      </div>
    </div>
  );
...
export default function LuMane(){
  ...
  // âœ… FIX PRINCIPAL: detectar pago exitoso de Stripe, login y acceso guardado
  useEffect(() => {
    try {
  ...
  const PLANS = {
    ...
    annual:  {id:"annual",  label:"Anual",   price:"$59.99", period:"/aÃ±o", savings:"Ahorra 50% Â· antes $120", priceNum:59.99},
  };
  ...
  function doLogin(){
    ...
    } catch(e){ setLoginError("Error al iniciar sesiÃ³n."); }
  }
  ...
  function handlePhotoUpload(e){
    ...
    // Usar URL.createObjectURL primero (mÃ¡s rÃ¡pido y funciona con Google Fotos)
  ...
  async function runAI(ans){
    ...
    const prompt=`Eres tricÃ³loga experta. Analiza: GÃ©nero:${ans.gender} Grupo:${ans.group} Subtipo:${ans.subtype||ans.group} Cuero:${ans.scalp} PreocupaciÃ³n:${ans.concern} Tratamientos:${ans.damage}. Responde SOLO JSON: {"hairType":"${ans.subtype||ans.group}","condition":"seco|graso|normal","scalp":"normal|caspa|graso|sensible","title":"tÃ­tulo 5 palabras","summary":"descripciÃ³n 2-3 oraciones","score":{"hidratacion":7,"fuerza":6,"brillo":7,"salud_cuero":7},"products":[{"order":1,"step":"Limpieza","name":"","sq":"","why":"","howToApply":"","freq":"","tip":"","avoid":""},{"order":2,"step":"Acondicionado","name":"","sq":"","why":"","howToApply":"","freq":"","tip":"","avoid":""},{"order":3,"step":"Tratamiento","name":"","sq":"","why":"","howToApply":"","freq":"","tip":"","avoid":""},{"order":4,"step":"DefiniciÃ³n","name":"","sq":"","why":"","howToApply":"","freq":"","tip":"","avoid":""},{"order":5,"step":"Sellado","name":"","sq":"","why":"","howToApply":"","freq":"","tip":"","avoid":""}],"weeklyRoutine":["DÃ­as 1-2:","DÃ­as 3-4:","DÃ­as 5-7:"],"ingredients":{"buscar":["i1","i2","i3"],"evitar":["i1","i2"]},"lifestyle":["h1","h2","h3"]}`;
    try{
      const msgs=hairPhoto
        ?(()=>{
          ...
          const b64=parts[1];
          return [{role:"user",content:[{type:"image",source:{type:"base64",media_type:mime,data:b64}},{type:"text",text:prompt+" Analiza tambiÃ©n la imagen del cabello para mayor precisiÃ³n."}]}];
        })()
  ...
  function openStore(query,key){
    ...
    showToast("Abriendo "+s.name+"â€¦ ðŸ›ï¸");
  }
  ...
  const CountdownBanner=()=>(
    <div style={{background:"linear-gradient(135deg,#6B1F8A,#9B1B6E,#C4187A)",padding:"0.65rem 1.2rem",display:"flex",alignItems:"center",justifyContent:"center",gap:"0.8rem",flexWrap:"wrap",boxShadow:"0 4px 20px rgba(107,31,138,.4)",animation:"bannerBounce 2.5s ease-in-out infinite, bannerGlow 2s ease-in-out infinite"}}>
      <span style={{color:"#fff",fontSize:"0.8rem",fontWeight:600}}>ðŸ”¥ <strong>47 personas</strong> viendo esto ahora Â· 7 dÃ­as GRATIS Â· Desde <strong>{"$2.99/sem"}</strong></span>
  ...
  const PaywallModal=()=>(
    <div style={{position:"fixed",inset:0,background:"rgba(42,16,24,.75)",zIndex:700,display:"flex",alignItems:"center",justifyContent:"center",padding:"1rem",backdropFilter:"blur(4px)"}}>
      <div style={{background:"#FDF4F5",borderRadius:"1.8rem",maxWidth:"460px",width:"100%",boxShadow:"0 40px 100px rgba(0,0,0,.4)",overflow:"hidden"}}>
        {subStep===1&&(
          <div>
            <div style={{background:"linear-gradient(135deg,#6B1F8A,#C4687A)",padding:"2rem",textAlign:"center",position:"relative"}}>
              <button onClick={()=>{setShowPaywall(false);setSubStep(1);}} style={{position:"absolute",top:"1rem",right:"1rem",background:"rgba(255,255,255,.15)",border:"none",color:"#fff",width:"28px",height:"28px",borderRadius:"50%",cursor:"pointer",fontSize:"0.85rem"}}>âœ•</button>
              <div style={{display:"inline-flex",alignItems:"center",gap:"0.4rem",background:"rgba(255,255,255,.15)",border:"1px solid rgba(255,255,255,.3)",borderRadius:"2rem",padding:"0.28rem 0.8rem",marginBottom:"0.7rem"}}>
                <span style={{fontSize:"0.72rem",fontWeight:700,color:"#FFD4E0"}}>â±ï¸ Expira en <strong style={{fontFamily:"monospace",color:"#fff"}}>{fmtCountdown(countdown)}</strong></span>
              </div>
              <div style={{fontSize:"2rem",marginBottom:"0.3rem"}}>âœ¦</div>
              ...
              <p style={{color:"rgba(255,255,255,.7)",fontSize:"0.82rem"}}>Analizador IA Â· Rutinas Â· Tienda completa</p>
            </div>
            <div style={{padding:"1.5rem"}}>
              <div style={{background:"rgba(196,104,122,.08)",border:"1.5px solid rgba(196,104,122,.25)",borderRadius:"1rem",padding:"0.9rem",marginBottom:"1.2rem",textAlign:"center"}}>
                <div style={{fontSize:"0.68rem",fontWeight:700,color:"#C4687A",letterSpacing:"0.15em",textTransform:"uppercase"}}>ðŸŽ 7 dÃ­as completamente gratis</div>
                ...
                <button key={plan.id} onClick={()=>setSelectedPlan(plan.id)}
                  ...
                  <div style={{display:"flex",alignItems:"center",gap:"0.6rem"}}>
                    ...
                    <div style={{textAlign:"left"}}>
                      <div style={{fontWeight:700,fontSize:"0.85rem",color:"#2A1018"}}>{plan.label}{plan.id==="annual"&&<span style={{marginLeft:"0.4rem",background:"#FFD700",color:"#4A0070",fontSize:"0.6rem",fontWeight:700,padding:"0.1rem 0.4rem",borderRadius:"2rem"}}>â­ Popular</span>}</div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:"0.35rem",margin:"0.8rem 0 1.2rem"}}>
                {["ðŸ¤– Analizador IA subtipo exacto 1Aâ€“4C","ðŸ“¸ AnÃ¡lisis con foto de tu cabello","ðŸ“‹ Rutina personalizada paso a paso","ðŸ›ï¸ Tienda + Amazon, Sephora, iHerb, Druni","ðŸ’§ GuÃ­a agua calcÃ¡rea Europa","ðŸ”„ AnÃ¡lisis ilimitados"].map((b,i)=>(
                  <div key={i} style={{display:"flex",gap:"0.5rem",fontSize:"0.8rem",color:"#3A1020"}}>
                    <span style={{color:"#5A9A5A",fontWeight:700,flexShrink:0}}>âœ“</span>{b}
                  </div>
                ))}
              </div>
              <button onClick={()=>{setShowPaywall(false);setPage("register");setRegError("");setRegData({nombre:"",apellido:"",nacimiento:"",email:"",password:"",confirm:""});}} style={{width:"100%",background:"linear-gradient(135deg,#6B1F8A,#C4687A)",color:"#fff",border:"none",padding:"0.95rem",borderRadius:"3rem",fontSize:"0.97rem",fontWeight:700,cursor:"pointer",fontFamily:"'Outfit',sans-serif",marginBottom:"0.5rem"}}>
                Comenzar 7 dÃ­as gratis â†’
              </button>
              <p style={{textAlign:"center",fontSize:"0.68rem",opacity:.4,lineHeight:1.4}}>Sin cargos durante la prueba. DespuÃ©s {PLANS[selectedPlan].price}{PLANS[selectedPlan].period}.</p>
            </div>
          </div>
        )}
        {subStep===2&&(
          <div>
            <div style={{background:"linear-gradient(135deg,#6B1F8A,#C4687A)",padding:"1.3rem 1.5rem",display:"flex",alignItems:"center",gap:"1rem"}}>
              <button onClick={()=>setSubStep(1)} style={{background:"rgba(255,255,255,.15)",border:"none",color:"#fff",width:"28px",height:"28px",borderRadius:"50%",cursor:"pointer",fontSize:"0.8rem",flexShrink:0}}>â†</button>
              <div>
                <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.3rem",fontWeight:700,color:"#fff"}}>Crea tu cuenta</h2>
                <p style={{color:"rgba(255,255,255,.6)",fontSize:"0.74rem"}}>Paso 1 de 2 Â· Datos personales</p>
              </div>
              <button onClick={()=>{setShowPaywall(false);setSubStep(1);}} style={{marginLeft:"auto",background:"rgba(255,255,255,.15)",border:"none",color:"#fff",width:"28px",height:"28px",borderRadius:"50%",cursor:"pointer",fontSize:"0.8rem"}}>âœ•</button>
            </div>
            <div style={{padding:"1.5rem",overflowY:"auto",maxHeight:"70vh"}} onClick={e=>e.stopPropagation()}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"0.8rem",marginBottom:"0.8rem"}}>
                <div>
                  <label style={{fontSize:"0.65rem",fontWeight:700,color:"#5A2030",letterSpacing:"0.08em",textTransform:"uppercase",display:"block",marginBottom:"0.4rem"}}>Nombre *</label>
                  <input value={regData.nombre} onChange={e=>setRegData(p=>({...p,nombre:e.target.value}))} placeholder="Tu nombre"
                    style={{width:"100%",padding:"10px 12px",borderRadius:10,border:"1.5px solid rgba(196,104,122,.25)",fontFamily:"'Outfit',sans-serif",fontSize:14,color:"#2A1018",outline:"none",background:"#FDF4F5",pointerEvents:"auto",position:"relative",zIndex:999}}/>
                </div>
                <div>
                  <label style={{fontSize:"0.65rem",fontWeight:700,color:"#5A2030",letterSpacing:"0.08em",textTransform:"uppercase",display:"block",marginBottom:"0.4rem"}}>Apellido</label>
                  <input value={regData.apellido} onChange={e=>setRegData(p=>({...p,apellido:e.target.value}))} placeholder="Tu apellido"
              ...
              <button onClick={doRegister} disabled={subLoading}
                ...
                {subLoading?"Redirigiendo a Stripeâ€¦":"Continuar al pago â†’"}
              </button>
              <p style={{textAlign:"center",fontSize:"0.68rem",opacity:.4,lineHeight:1.4}}>Paso 2: pagarÃ¡s de forma segura con Stripe</p>
            </div>
          </div>
        )}
        {subStep===3&&(
          <div style={{padding:"3rem 2rem",textAlign:"center"}}>
            ...
            <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.9rem",fontWeight:700,color:"#2A1018",marginBottom:"0.5rem"}}>Â¡Bienvenida a Premium!</h2>
            <p style={{fontSize:"0.88rem",opacity:.7,lineHeight:1.65,marginBottom:"1.2rem"}}>Tu suscripciÃ³n estÃ¡ activa. Disfruta todo LuMane sin lÃ­mites.</p>
    ...
    <div style={{position:"fixed",inset:0,background:"rgba(42,16,24,.85)",zIndex:800,display:"flex",alignItems:"center",justifyContent:"center",padding:"1rem",backdropFilter:"blur(6px)"}}>
      <div style={{background:"#FDF4F5",borderRadius:"1.8rem",maxWidth:"400px",width:"100%",boxShadow:"0 40px 100px rgba(0,0,0,.4)",overflow:"hidden"}}>
        <div style={{background:"linear-gradient(135deg,#6B1F8A,#C4687A)",padding:"2rem",textAlign:"center"}}>
          <div style={{fontSize:"2rem",marginBottom:"0.4rem"}}>âœ¦</div>
          ...
          <p style={{color:"rgba(255,255,255,.7)",fontSize:"0.82rem"}}>Inicia sesiÃ³n para acceder a tu cuenta</p>
        </div>
        <div style={{padding:"1.8rem"}}>
          ...
          <p style={{textAlign:"center",fontSize:"0.72rem",color:"#999"}}>
            Â¿No tienes cuenta?{" "}
            <span onClick={()=>{setShowLogin(false);setShowPaywall(true);setSubStep(1);}} style={{color:"#C4687A",fontWeight:700,cursor:"pointer"}}>SuscrÃ­bete aquÃ­</span>
          </p>
        </div>
      </div>
    </div>
    ...
    <div style={{position:"fixed",inset:0,background:"rgba(42,16,24,.65)",zIndex:600,display:"flex",alignItems:"center",justifyContent:"center",padding:"1rem"}} onClick={()=>setShowStores(false)}>
      <div style={{background:"#FDF4F5",borderRadius:"1.5rem",padding:"1.8rem",maxWidth:"440px",width:"100%",boxShadow:"0 30px 80px rgba(0,0,0,.3)"}} onClick={e=>e.stopPropagation()}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"1rem"}}>
          ...
          <button onClick={()=>setShowStores(false)} style={{background:"none",border:"none",fontSize:"1.1rem",cursor:"pointer",color:"#999"}}>âœ•</button>
        </div>
  ...
  const HomePage=()=>(
    <div>
        ...
        <div style={{position:"relative",zIndex:1,maxWidth:"580px"}} className="fade">
          ...
          <div style={{display:"flex",gap:"0.5rem",justifyContent:"center",marginBottom:"1rem",flexWrap:"wrap"}}>
            <div style={{display:"flex",alignItems:"center",gap:"0.4rem",background:"rgba(196,104,122,.12)",border:"1px solid rgba(196,104,122,.3)",borderRadius:"2rem",padding:"0.35rem 1rem"}}>
              <span>ðŸ‘©</span><span style={{fontSize:"0.75rem",fontWeight:700,color:"#C4687A"}}>Para ella</span>
            </div>
            <div style={{display:"flex",alignItems:"center",gap:"0.4rem",background:"rgba(42,90,138,.12)",border:"1px solid rgba(42,90,138,.3)",borderRadius:"2rem",padding:"0.35rem 1rem"}}>
              <span>ðŸ‘¨</span><span style={{fontSize:"0.75rem",fontWeight:700,color:"#2A5A8A"}}>Para Ã©l</span>
            </div>
          </div>
          ...
          <div style={{background:"linear-gradient(135deg,rgba(196,104,122,.07),rgba(212,132,154,.11))",border:"1px solid rgba(196,104,122,.2)",borderRadius:"1.3rem",padding:"1.4rem 1.6rem",marginBottom:"2rem",maxWidth:"480px",margin:"0 auto 2rem"}}>
            <p style={{fontSize:"1rem",lineHeight:1.8,color:"#3A1020",fontWeight:400,marginBottom:"0.7rem"}}>
              <strong style={{fontWeight:700,color:"#C4687A"}}>Sin importar tu raza, tu gÃ©nero ni tu textura</strong> â€” en LuMane creemos que cada cabello del mundo merece cuidado real, amor genuino y los mejores productos.
            </p>
            <p style={{fontSize:"0.88rem",lineHeight:1.75,color:"#5A2030",fontWeight:300}}>
              Desde coils 4C hasta lacio 1A â€” cubrimos los <strong style={{fontWeight:600}}>12 tipos de cabello</strong> con rutinas e instrucciones paso a paso. <em>Tu cabello tiene nombre, y tiene soluciÃ³n.</em>
            </p>
          </div>
          <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:"0.7rem",marginBottom:"2.5rem"}}>
            <button onClick={goQuiz} style={{background:"linear-gradient(135deg,#6B1F8A,#C4687A)",color:"#fff",border:"none",padding:"1.05rem 2.6rem",borderRadius:"3rem",fontSize:"1rem",fontWeight:700,cursor:"pointer",fontFamily:"'Outfit',sans-serif",boxShadow:"0 10px 32px rgba(107,31,138,.35)"}}>
              âœ¨ Descubrir mi tipo de cabello
            </button>
            <span style={{fontSize:"0.73rem",opacity:.45}}>ðŸŽ 7 dÃ­as gratis Â· desde {"$2.99/sem"} Â· cancela cuando quieras</span>
          </div>
          <div style={{display:"flex",gap:"2rem",justifyContent:"center",flexWrap:"wrap"}}>
            {[{n:"12",l:"Tipos"},{n:"28+",l:"Productos"},{n:"7",l:"DÃ­as gratis"}].map(s=>(
              <div key={s.n}>
      ...
      <div style={{padding:"2.5rem 1.5rem",background:"#FDF4F5"}}>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(240px,1fr))",gap:"1rem",maxWidth:"700px",margin:"0 auto"}}>
          <div className="lift" onClick={()=>{setPage("shop");setShopFilter("all");}} style={{background:"linear-gradient(135deg,rgba(196,104,122,.1),rgba(212,132,154,.15))",border:"1.5px solid rgba(196,104,122,.3)",borderRadius:"1.3rem",padding:"1.5rem",cursor:"pointer",textAlign:"center"}}>
            ...
            <p style={{fontSize:"0.8rem",opacity:.65,lineHeight:1.5,marginBottom:"0.8rem"}}>Rutinas para todos los tipos â€” del lacio 1A al afro 4C.</p>
            <div style={{fontSize:"0.78rem",color:"#C4687A",fontWeight:700}}>Ver rutinas femeninas â†’</div>
          </div>
          <div className="lift" onClick={()=>{setPage("shop");setShopFilter("hombre");}} style={{background:"linear-gradient(135deg,rgba(42,90,138,.1),rgba(74,106,154,.15))",border:"1.5px solid rgba(42,90,138,.3)",borderRadius:"1.3rem",padding:"1.5rem",cursor:"pointer",textAlign:"center"}}>
            ...
            <p style={{fontSize:"0.8rem",opacity:.65,lineHeight:1.5,marginBottom:"0.8rem"}}>Shampoo, anticaÃ­da y estilizado especÃ­fico para hombre.</p>
            <div style={{fontSize:"0.78rem",color:"#2A5A8A",fontWeight:700}}>Ver productos masculinos â†’</div>
          </div>
        </div>
      </div>
      ...
      <div style={{padding:"3rem 1.5rem",background:"#F5E8EA"}}>
        <div style={{textAlign:"center",marginBottom:"1.8rem"}}>
          <div style={{fontSize:"0.65rem",color:"#C4687A",fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",marginBottom:"0.4rem"}}>âœ¦ Simple y rÃ¡pido</div>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(190px,1fr))",gap:"1rem",maxWidth:"680px",margin:"0 auto"}}>
          {[{n:"1",emoji:"ðŸ”Ž",t:"Responde 6 preguntas",d:"La IA analiza tu tipo, textura y preocupaciones."},{n:"2",emoji:"ðŸ“¸",t:"Sube foto (opcional)",d:"La IA ve tu cabello real para mayor precisiÃ³n."},{n:"3",emoji:"ðŸ›ï¸",t:"Compra los productos",d:"Links a Amazon, iHerb, Sephora y Druni."}].map(s=>(
      ...
      <div style={{padding:"3rem 1.5rem",background:"linear-gradient(135deg,#2A1018,#6B1F8A,#2A5A8A)",textAlign:"center"}}>
        <div style={{maxWidth:"640px",margin:"0 auto"}}>
          <div style={{fontSize:"2.2rem",marginBottom:"0.8rem"}}>ðŸŒ</div>
          <div style={{fontSize:"0.68rem",color:"rgba(255,255,255,.6)",fontWeight:700,letterSpacing:"0.18em",textTransform:"uppercase",marginBottom:"0.6rem"}}>âœ¦ Para toda nuestra comunidad</div>
          <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(1.5rem,4vw,2.2rem)",fontWeight:700,color:"#FDF4F5",marginBottom:"1.2rem",lineHeight:1.4}}>
            Desde <em style={{color:"#E8A0B0",fontStyle:"italic"}}>CentroamÃ©rica y el Caribe ðŸŒ´</em>, pasando por toda <em style={{color:"#E8A0B0",fontStyle:"italic"}}>SudamÃ©rica ðŸŒŽ</em> y <em style={{color:"#E8A0B0",fontStyle:"italic"}}>NorteamÃ©rica ðŸ‡ºðŸ‡¸</em>, hasta llegar a <em style={{color:"#90D4FF",fontStyle:"italic"}}>Europa ðŸ‡ªðŸ‡º</em> â€” LuMane tiene la rutina perfecta para tu cabello.
          </h2>
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(140px,1fr))",gap:"0.7rem",marginBottom:"1.5rem",maxWidth:"580px",margin:"0 auto 1.5rem"}}>
            {[
              {flag:"ðŸŒŽ",pais:"LatinoamÃ©rica",tip:"MÃ©xico Â· Colombia Â· Argentina Â· PerÃº Â· Guatemala y mÃ¡s"},
              {flag:"ðŸ‡ºðŸ‡¸",pais:"Estados Unidos",tip:"Agua con cloro y minerales"},
              {flag:"ðŸ‡ªðŸ‡º",pais:"Europa",tip:"Agua calcÃ¡rea en EspaÃ±a, BÃ©lgica, Francia y mÃ¡s"},
            ].map((p,i)=>(
          ...
          <button onClick={()=>{setPage("shop");setShopFilter("cal");}} style={{background:"linear-gradient(135deg,#E8A0B0,#C4687A)",color:"#fff",border:"none",padding:"0.85rem 2rem",borderRadius:"3rem",fontSize:"0.88rem",fontWeight:700,cursor:"pointer",fontFamily:"'Outfit',sans-serif",boxShadow:"0 8px 25px rgba(196,104,122,.4)"}}>
            Ver soluciones para mi regiÃ³n â†’
          </button>
        </div>
      </div>
      ...
      <div style={{padding:"3rem 1.5rem",background:"#FDF4F5"}}>
        <div style={{textAlign:"center",marginBottom:"1.5rem"}}>
          <div style={{fontSize:"0.65rem",color:"#C4687A",fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",marginBottom:"0.4rem"}}>âœ¦ Para todos</div>
          <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(1.5rem,4vw,2.2rem)",fontWeight:700}}>Del 1A al 4C â€” te cubrimos</h2>
        </div>
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(150px,1fr))",gap:"0.75rem",maxWidth:"720px",margin:"0 auto 1.2rem"}}>
          {[{id:"lacio",emoji:"ã€°ï¸",title:"Lacio",color:"#B8924A",sub:"1A Â· 1B Â· 1C"},{id:"ondulado",emoji:"ã€œ",title:"Ondulado",color:"#5A9C90",sub:"2A Â· 2B Â· 2C"},{id:"rizado",emoji:"ðŸŒ€",title:"Rizado",color:"#8A60B8",sub:"3A Â· 3B Â· 3C"},{id:"afro",emoji:"âœ¦",title:"Afro/Coily",color:"#B86830",sub:"4A Â· 4B Â· 4C"}].map(g=>(
        ...
        <div style={{display:"flex",gap:"0.45rem",flexWrap:"wrap",justifyContent:"center"}}>
          {[{id:"caspa",emoji:"â„ï¸",l:"Caspa"},{id:"caida",emoji:"ðŸ‚",l:"CaÃ­da"},{id:"cuero",emoji:"ðŸ”¬",l:"Cuero"},{id:"regenerar",emoji:"ðŸŒ±",l:"Regenerar"},{id:"cal",emoji:"ðŸ’§",l:"Anti-Cal"},{id:"hombre",emoji:"ðŸ’ª",l:"Hombre"}].map(c=>(
      ...
      <div style={{padding:"3rem 1.5rem",background:"#F5E8EA"}}>
        <div style={{textAlign:"center",marginBottom:"1.5rem"}}>
          <div style={{fontSize:"0.65rem",color:"#C4687A",fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",marginBottom:"0.4rem"}}>âœ¦ Lo que dicen</div>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(230px,1fr))",gap:"0.9rem",maxWidth:"760px",margin:"0 auto"}}>
          {[{n:"MarÃ­a, MÃ©xico ðŸ‡²ðŸ‡½",t:"3C",q:"Â¡Por fin entiendo mi cabello! En 3 semanas ya veo la diferencia.",s:5},{n:"Valentina, Colombia ðŸ‡¨ðŸ‡´",t:"2B",q:"Llevaba aÃ±os gastando en productos que no funcionaban. Â¡Ahora mis ondas estÃ¡n perfectas!",s:5},{n:"Andrea, EspaÃ±a ðŸ‡ªðŸ‡¸",t:"Cal",q:"El agua de Madrid me tenÃ­a el cabello horrible. Los productos anti-cal son una revoluciÃ³n.",s:5}].map((r,i)=>(
            <div key={i} style={{background:"#FDF4F5",borderRadius:"1rem",padding:"1.2rem",border:"1px solid rgba(196,104,122,.11)"}}>
              <div style={{display:"flex",gap:"0.18rem",marginBottom:"0.55rem"}}>
                {[...Array(r.s)].map((_,j)=><span key={j} style={{color:"#FFB800",fontSize:"0.82rem"}}>â˜…</span>)}
              </div>
      ...
      <div style={{padding:"2rem 1.5rem",background:"#FDF4F5"}}>
        <div style={{maxWidth:"620px",margin:"0 auto",display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(180px,1fr))",gap:"0.8rem"}}>
          {[{emoji:"ðŸŽ",title:"7 dÃ­as gratis",desc:"Prueba todo LuMane sin pagar nada. Sin compromisos."},{emoji:"ðŸ”’",title:"Pago 100% seguro",desc:"Datos protegidos con encriptaciÃ³n SSL de nivel bancario."},{emoji:"âš¡",title:"Resultado inmediato",desc:"Recibes tu rutina personalizada en menos de 30 segundos."},{emoji:"âŒ",title:"Sin permanencia",desc:"Cancela cuando quieras. Sin llamadas, sin formularios."}].map((f,i)=>(
      ...
      <div style={{background:"linear-gradient(135deg,#2A1018,#6B1F8A)",padding:"4rem 1.5rem",textAlign:"center",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{position:"relative",zIndex:1,maxWidth:"500px",margin:"0 auto"}}>
          ...
          <p style={{color:"rgba(251,247,240,.6)",fontSize:"0.88rem",lineHeight:1.7,marginBottom:"1.5rem"}}>6 preguntas Â· Foto opcional Â· 7 dÃ­as completamente gratis</p>
          <button onClick={goQuiz} style={{background:"linear-gradient(135deg,#C4687A,#E8A0B0)",color:"#2A1018",border:"none",padding:"1rem 2.4rem",borderRadius:"3rem",fontSize:"0.97rem",fontWeight:700,cursor:"pointer",fontFamily:"'Outfit',sans-serif",boxShadow:"0 10px 35px rgba(196,104,122,.4)",marginBottom:"1.2rem"}}>
            Comenzar anÃ¡lisis gratuito âœ¨
          </button>
          {!isSubscribed()&&(
      ...
      return(
        <div style={{minHeight:"85vh",display:"flex",alignItems:"center",justifyContent:"center",padding:"3rem 1.5rem",background:"#FDF4F5"}}>
          <div style={{maxWidth:"540px",width:"100%",textAlign:"center"}} className="fade">
            ...
            <div style={{fontSize:"0.65rem",color:"#C4687A",fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",marginBottom:"0.5rem"}}>Paso final Â· Opcional</div>
            <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(1.4rem,4vw,2rem)",fontWeight:700,marginBottom:"0.8rem",lineHeight:1.3,color:"#2A1018"}}>
              Â¿Nos muestras tu cabello?<br/><em style={{fontStyle:"italic",color:"#C4687A",fontSize:"85%"}}>La IA lo analizarÃ¡ para un resultado mÃ¡s exacto</em>
            </h2>
            <p style={{fontSize:"0.85rem",opacity:.6,lineHeight:1.7,marginBottom:"1.5rem",maxWidth:"400px",margin:"0 auto 1.5rem"}}>Sube una foto y nuestra IA detectarÃ¡ el tipo exacto, la porosidad y lo que realmente necesita tu cabello.</p>
            <div style={{marginBottom:"1.5rem"}}>
              ...
              {photoLoading?(
                <div style={{padding:"2rem",border:"2px dashed rgba(196,104,122,.4)",borderRadius:"1.2rem",background:"rgba(196,104,122,.04)",textAlign:"center"}}>
                  <div style={{fontSize:"2rem"}} className="spin">âœ¦</div>
                  <div style={{fontSize:"0.85rem",color:"#C4687A",fontWeight:600,marginTop:"0.5rem"}}>Cargando fotoâ€¦</div>
                </div>
              ):hairPhoto?(
                <div style={{textAlign:"center"}}>
                  <div style={{position:"relative",display:"inline-block"}}>
                    <img src={hairPhoto} alt="Tu cabello" style={{width:"220px",height:"220px",objectFit:"cover",borderRadius:"1.2rem",border:"3px solid #5A9A5A",boxShadow:"0 8px 28px rgba(90,154,90,.3)"}}/>
                    <button onClick={()=>setHairPhoto(null)} style={{position:"absolute",top:"-8px",right:"-8px",width:"30px",height:"30px",borderRadius:"50%",background:"#C4687A",border:"2px solid #fff",color:"#fff",cursor:"pointer",fontSize:"0.9rem",fontWeight:700}}>âœ•</button>
                  </div>
                  <div style={{marginTop:"0.8rem",fontSize:"0.9rem",color:"#5A9A5A",fontWeight:700}}>âœ… Â¡Foto lista! La IA analizarÃ¡ tu cabello</div>
                </div>
              ):(
                <div style={{textAlign:"center"}}>
                  <div style={{fontSize:"2.5rem",marginBottom:"0.8rem"}}>ðŸ“·</div>
                  ...
                  />
                  <div style={{fontSize:"0.75rem",color:"#999"}}>JPG Â· PNG Â· HEIC</div>
                </div>
              )}
            </div>
            <div style={{display:"flex",flexDirection:"column",gap:"0.7rem"}}>
              <button onClick={()=>runAI(answers)}
                ...
                {hairPhoto?"ðŸ“¸ Analizar con mi foto â†’":"âœ¨ Analizar sin foto"}
              </button>
              {!hairPhoto&&(
          ...
          <div style={{display:"flex",flexDirection:"column",gap:"0.65rem"}}>
            {currentQ.opts.map(opt=>(
              <button key={opt.v} onClick={()=>handleAnswer(currentQ.id,opt.v)}
                ...
                <span style={{color:"#C4687A",opacity:.35}}>â†’</span>
              </button>
            ))}
          </div>
          {quizStep>0&&<button onClick={()=>setQuizStep(s=>s-1)} style={{display:"block",margin:"1.2rem auto 0",background:"none",border:"none",color:"#C4687A",fontSize:"0.8rem",cursor:"pointer",fontFamily:"'Outfit',sans-serif",opacity:.65}}>â† Anterior</button>}
        </div>
      </div>
    );
  };
    ...
    <div style={{padding:"2rem 1.5rem 4rem",background:"#FDF4F5"}}>
      {loading?(
        <div style={{minHeight:"70vh",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:"1.5rem"}}>
          <div style={{fontSize:"3rem"}} className="spin">âœ¦</div>
          <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.8rem",color:"#C4687A"}}>Analizando tu cabelloâ€¦</h2>
        ...
        <div style={{maxWidth:"800px",margin:"0 auto"}} className="fade">
          <div style={{background:"linear-gradient(135deg,rgba(107,31,138,.07),rgba(196,104,122,.1))",border:"1px solid rgba(196,104,122,.2)",borderRadius:"1.6rem",padding:"2rem",textAlign:"center",marginBottom:"1.8rem"}}>
            <div style={{display:"inline-block",background:"rgba(196,104,122,.12)",border:"1px solid rgba(196,104,122,.3)",color:"#C4687A",fontSize:"0.65rem",fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",padding:"0.28rem 0.9rem",borderRadius:"2rem",marginBottom:"0.9rem"}}>âœ¦ Tu anÃ¡lisis LuMane</div>
            ...
            <div style={{display:"flex",gap:"0.45rem",justifyContent:"center",flexWrap:"wrap",marginBottom:"1rem"}}>
              {[{l:"Tipo",v:result.hairType},{l:"CondiciÃ³n",v:result.condition},{l:"Cuero",v:result.scalp}].map(t=>(
                ...
                <div key={i} style={{background:"#fff",borderRadius:"1rem",border:"1.5px solid "+(isOpen?"rgba(107,31,138,.35)":"rgba(196,104,122,.12)"),overflow:"hidden"}}>
                  <button onClick={()=>setExpanded(isOpen?null:i)} style={{width:"100%",display:"flex",alignItems:"center",gap:"0.9rem",padding:"0.95rem 1.2rem",background:"none",border:"none",cursor:"pointer",textAlign:"left",fontFamily:"'Outfit',sans-serif"}}>
                    ...
                    <div style={{flex:1}}>
                      ...
                      <div style={{fontSize:"0.68rem",opacity:.45,marginTop:"0.06rem"}}>ðŸ“… {p.freq}</div>
                    </div>
                    <span style={{color:"#C4687A",fontSize:"1rem",transition:"transform .22s",transform:isOpen?"rotate(180deg)":"none",flexShrink:0}}>âŒ„</span>
                  </button>
                  {isOpen&&(
                    <div style={{padding:"0 1.2rem 1.2rem",borderTop:"1px solid rgba(196,104,122,.08)"}} className="fade">
                      <div style={{padding:"0.8rem",background:"rgba(196,104,122,.05)",borderRadius:"0.65rem",margin:"0.8rem 0",fontSize:"0.8rem",lineHeight:1.6,color:"#5A2030"}}>
                        <strong style={{fontSize:"0.6rem",color:"#C4687A",letterSpacing:"0.1em",textTransform:"uppercase",display:"block",marginBottom:"0.25rem"}}>Â¿Por quÃ© este producto?</strong>
                        {p.why}
                      </div>
                      ...
                      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"0.6rem",marginBottom:"0.9rem"}}>
                        <div style={{padding:"0.7rem",background:"rgba(90,154,90,.07)",borderRadius:"0.6rem",border:"1px solid rgba(90,154,90,.18)"}}>
                          <div style={{fontSize:"0.58rem",fontWeight:700,color:"#5A9A5A",letterSpacing:"0.1em",textTransform:"uppercase",marginBottom:"0.2rem"}}>ðŸ’¡ Truco</div>
                        ...
                        <div style={{padding:"0.7rem",background:"rgba(170,85,85,.06)",borderRadius:"0.6rem",border:"1px solid rgba(170,85,85,.16)"}}>
                          <div style={{fontSize:"0.58rem",fontWeight:700,color:"#AA5555",letterSpacing:"0.1em",textTransform:"uppercase",marginBottom:"0.2rem"}}>âš ï¸ Evitar</div>
                          <p style={{fontSize:"0.76rem",opacity:.85,lineHeight:1.45}}>{p.avoid}</p>
                        </div>
                      </div>
                      <div style={{fontSize:"0.58rem",fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase",opacity:.4,marginBottom:"0.5rem"}}>ðŸ›ï¸ Comprar en</div>
          ...
          <div style={{display:"flex",gap:"0.65rem",justifyContent:"center",flexWrap:"wrap"}}>
            <button onClick={()=>setPage("shop")} style={{background:"linear-gradient(135deg,#6B1F8A,#C4687A)",color:"#fff",border:"none",padding:"0.8rem 1.8rem",borderRadius:"3rem",fontSize:"0.88rem",fontWeight:700,cursor:"pointer",fontFamily:"'Outfit',sans-serif"}}>Ver tienda â†’</button>
            <button onClick={goQuiz} style={{background:"transparent",color:"#C4687A",border:"1.5px solid rgba(196,104,122,.4)",padding:"0.8rem 1.8rem",borderRadius:"3rem",fontSize:"0.88rem",cursor:"pointer",fontFamily:"'Outfit',sans-serif"}}>Repetir anÃ¡lisis</button>
          </div>
        </div>
      )}
    </div>
      ...
      <div style={{background:"#fff",borderRadius:"1rem",overflow:"hidden",border:"1.5px solid "+(open?"rgba(107,31,138,.3)":"rgba(196,104,122,.1)"),transition:"all .2s"}} className="lift">
        ...
        <div style={{padding:"0.85rem"}}>
          ...
          <button onClick={()=>setOpen(!open)} style={{width:"100%",padding:"0.45rem",background:"rgba(196,104,122,.06)",border:"1px solid rgba(196,104,122,.15)",borderRadius:"0.6rem",cursor:"pointer",fontSize:"0.72rem",color:"#C4687A",fontWeight:600,marginBottom:open?"0.65rem":0,fontFamily:"'Outfit',sans-serif"}}>
            {open?"â–² Ocultar":"â–¼ Ver instrucciones + Comprar"}
          </button>
          {open&&(
            <div className="fade">
  ...
  const ShopPage=()=>{
    ...
    return(
      <div style={{padding:"2.5rem 1.5rem 4rem",maxWidth:"980px",margin:"0 auto"}}>
        <div style={{textAlign:"center",marginBottom:"1.8rem"}}>
          <div style={{fontSize:"0.65rem",color:"#C4687A",fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",marginBottom:"0.4rem"}}>âœ¦ CatÃ¡logo completo</div>
          <h1 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"2.4rem",fontWeight:700,color:"#2A1018"}}>Tienda LuMane</h1>
          <p style={{opacity:.45,marginTop:"0.35rem",fontSize:"0.84rem"}}>28+ productos Â· Tipos 1A al 4C Â· Para todas las razas y gÃ©neros</p>
        </div>
  ...
  const PricingPage=()=>(
    <div style={{padding:"3.5rem 1.5rem 5rem",background:"#FDF4F5",maxWidth:"720px",margin:"0 auto"}}>
      <div style={{textAlign:"center",marginBottom:"2.5rem"}}>
        <div style={{fontSize:"0.65rem",color:"#C4687A",fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",marginBottom:"0.4rem"}}>âœ¦ SuscripciÃ³n</div>
        <h1 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"clamp(1.9rem,5vw,2.8rem)",fontWeight:700,color:"#2A1018",marginBottom:"0.5rem",lineHeight:1.1}}>Cuida tu cabello<br/><em style={{fontStyle:"italic",color:"#C4687A"}}>sin lÃ­mites.</em></h1>
      </div>
      <div style={{background:"linear-gradient(135deg,#2A1018,#6B1F8A)",borderRadius:"1.8rem",padding:"2.2rem",marginBottom:"1.3rem",boxShadow:"0 20px 60px rgba(42,16,24,.3)"}}>
        <div style={{display:"flex",justifyContent:"space-between",flexWrap:"wrap",gap:"0.8rem",marginBottom:"1.5rem"}}>
          <div>
            <div style={{fontSize:"0.65rem",color:"#D4849A",fontWeight:700,letterSpacing:"0.15em",textTransform:"uppercase",marginBottom:"0.35rem"}}>âœ¦ Plan Premium</div>
          ...
          <div style={{textAlign:"right"}}>
            ...
            <div style={{fontSize:"0.7rem",color:"rgba(251,247,240,.45)"}}>desde /sem Â· 7 dÃ­as gratis</div>
          </div>
        </div>
        <div style={{background:"rgba(196,104,122,.18)",border:"1px solid rgba(196,104,122,.35)",borderRadius:"0.9rem",padding:"1rem 1.3rem",marginBottom:"1.5rem",display:"flex",alignItems:"center",gap:"0.9rem"}}>
          ...
          <div>
            <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.2rem",fontWeight:700,color:"#E8A0B0"}}>7 dÃ­as completamente gratis</div>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(185px,1fr))",gap:"0.55rem",margin:"1.3rem 0"}}>
          {["ðŸ¤– Analizador IA 1Aâ€“4C","ðŸ“¸ AnÃ¡lisis con foto","ðŸ“‹ Rutina personalizada","ðŸ›ï¸ Tienda completa","ðŸ’§ GuÃ­a anti-cal","ðŸ”„ Ilimitados"].map((f,i)=>(
            <div key={i} style={{display:"flex",alignItems:"center",gap:"0.45rem",color:"rgba(251,247,240,.75)",fontSize:"0.8rem"}}>
              <span style={{color:"#D4849A",fontWeight:700,flexShrink:0}}>âœ“</span>{f}
            </div>
          ))}
        </div>
        {!isSubscribed()?(
          ...
          <div style={{background:"rgba(90,154,90,.18)",border:"1px solid rgba(90,154,90,.35)",borderRadius:"0.9rem",padding:"0.9rem",textAlign:"center"}}>
            <div style={{color:"#90D490",fontWeight:700,fontSize:"0.9rem"}}>âœ¦ Premium activo</div>
          </div>
        )}
      </div>
      {isSubscribed()&&(
        <div style={{background:"rgba(170,85,85,.05)",border:"1px solid rgba(170,85,85,.16)",borderRadius:"0.9rem",padding:"1.1rem 1.3rem",display:"flex",alignItems:"center",justifyContent:"space-between",flexWrap:"wrap",gap:"0.8rem",marginTop:"1rem"}}>
          <div>
            <div style={{fontWeight:700,fontSize:"0.85rem",color:"#AA5555"}}>Cancelar suscripciÃ³n</div>
            <div style={{fontSize:"0.75rem",opacity:.55,marginTop:"0.12rem"}}>PerderÃ¡s el acceso premium.</div>
          </div>
    ...
    <div style={{minHeight:"100vh",background:"#FDF4F5"}}>
      ...
      <div className="splash">
        <div style={{display:"flex",flexDirection:"column",alignItems:"center",gap:"1rem"}}>
          <div style={{width:"80px",height:"80px",borderRadius:"50%",background:"rgba(255,255,255,.15)",border:"2px solid rgba(255,255,255,.35)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:"2.4rem"}}>âœ¦</div>
      ...
      <div style={{position:"sticky",top:0,zIndex:100,display:"flex",alignItems:"center",justifyContent:"space-between",padding:"0.85rem 1.2rem",background:"rgba(253,244,245,.96)",backdropFilter:"blur(14px)",borderBottom:"1px solid rgba(196,104,122,.11)"}}>
        <div onClick={()=>setPage("home")} style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.45rem",fontWeight:700,color:"#C4687A",cursor:"pointer",letterSpacing:"0.08em"}}>âœ¦ LuMane</div>
        <div style={{display:"flex",gap:"0.45rem",alignItems:"center"}}>
          {isSubscribed()?(
            ...
            <button onClick={()=>setShowPaywall(true)} style={{background:"linear-gradient(135deg,#6B1F8A,#C4687A)",color:"#fff",border:"none",padding:"0.32rem 0.85rem",borderRadius:"2rem",fontSize:"0.73rem",fontWeight:700,cursor:"pointer",fontFamily:"'Outfit',sans-serif"}}>ðŸŽ 7 dÃ­as gratis</button>
          )}
          <button onClick={()=>setShowStores(true)} style={{background:"rgba(196,104,122,.09)",border:"1px solid rgba(196,104,122,.18)",color:"#C4687A",padding:"0.32rem 0.65rem",borderRadius:"2rem",fontSize:"0.73rem",cursor:"pointer",fontFamily:"'Outfit',sans-serif"}}>âš™</button>
        </div>
      </div>
      ...
      <div className="page-content">
        ...
        <footer style={{background:"#2A1018",color:"rgba(253,244,245,.6)",padding:"2.2rem 2rem",textAlign:"center"}}>
          <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:"1.4rem",color:"#E8A0B0",marginBottom:"0.45rem",letterSpacing:"0.1em"}}>âœ¦ LuMane</div>
          ...
          {!isSubscribed()&&(
            <button onClick={()=>setShowPaywall(true)} style={{background:"linear-gradient(135deg,#6B1F8A,#C4687A)",color:"#fff",border:"none",padding:"0.5rem 1.3rem",borderRadius:"2rem",fontSize:"0.78rem",fontWeight:700,cursor:"pointer",fontFamily:"'Outfit',sans-serif",marginTop:"0.9rem"}}>
              ðŸŽ 7 dÃ­as gratis Â· desde {"$2.99/sem"}
            </button>
          )}
          <p style={{fontSize:"0.63rem",marginTop:"0.7rem",opacity:.25}}>Los enlaces pueden incluir comisiones de afiliado Â· LuMane Â© 2026</p>
        </footer>
      </div>
      <nav className="bottom-nav">
        {[{id:"home",icon:"ðŸ ",label:"Inicio"},{id:"quiz",icon:"ðŸ¤–",label:"Analizar"},{id:"shop",icon:"ðŸ›ï¸",label:"Tienda"},{id:"pricing",icon:"âœ¦",label:"Premium"}].map(item=>(
