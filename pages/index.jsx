...
export default function LuMane(){
  ...
  function activatePaid(){
    if(!subEmail||!subCard.num||!subCard.exp||!subCard.cvv||!subCard.name){showToast("Completa todos los campos");return;}
    setSubLoading(true);
    setTimeout(()=>{ setSubStatus("active");setSubLoading(false);setSubStep(3); },1500);
  }
